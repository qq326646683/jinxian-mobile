        ...
        return (
            <div style={{backgroundColor:'white'}}>
                ...
                <div style={{padding: 10}}>
                    <div style={{fontSize: 18, color: "black",}}>1.详细需求</div>
                    <img style={{marginTop:20}} width="100%"  src={constant.QINIU+"teamwork_step1.jpg"}/>
                    <div style={{fontSize: 12, color: "black",marginTop:20,paddingLeft:20}}>
                        1.客户提供开发的大概需求；<p/>
                    ...
                    <div style={{fontSize: 18, color: "black",marginTop:40}}>2.需求沟通</div>
                    ...
                    <div style={{fontSize: 18, color: "black",marginTop:40}}>3.合同签订</div>
                    ...
                    <div style={{fontSize: 18, color: "black",marginTop:40}}>4.开发及测试</div>
                    <img style={{marginTop:20}} width="100%"  src={constant.QINIU+"teamwork_step5.jpg"}/>
                    <div style={{fontSize: 12, color: "black",marginTop:20,paddingLeft:20,marginBottom:60}}>
